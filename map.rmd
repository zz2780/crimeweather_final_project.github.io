...
```{r}
#Obtain number of crimes in each zip region, sorting in descending order
number_of_crimes = 
  crime_df_map %>% 
  group_by(mod_zip) %>% 
...
In order to obtain crime rate, we get population size of each zip code region from [here](https://worldpopulationreview.com/zips/new-york).
...
We then convert zip code to modified zip code.
