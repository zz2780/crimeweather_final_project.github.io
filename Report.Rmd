...
We created an interactive map that shows the distribution of crime cases in the five boroughs of New York City. 

#### Shiny
The Shiny dashboard reports number of different offenses in NYC based on selected borough, hour of the day, days of the week, and season of the year.


After some exploratory analysis, we moved on to statistical analysis.
