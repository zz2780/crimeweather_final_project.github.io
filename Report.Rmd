---
title: "Report"
author: "Yucheng Li, Yunyi Jiang, Lydia Zhang, Hongmiao Wang, Mingkai(Charles) Chen"
output: 
  html_document:
    toc: true
    toc_float: true
...
In Our project, there are two datasets, including NYPD Complaint Data Historic and weather data.

We obtained crime data in New York City from NYC Open Data [NYPD Complaint Data Historic](https://data.cityofnewyork.us/Public-Safety/NYPD-Complaint-Data-Historic/qgea-i56i).
...
To display our results in a more interesting way, we created a shiny app which shows crime counts and rate in each modified zip code region for every 4-week interval. The shiny app can be accessed [here](https://liyc5215.shinyapps.io/r_shiny_map/).

```{r, eval=FALSE}
#data preparation
##cut `date` into 4 weeks interval
